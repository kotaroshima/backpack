...
width:"100%"});this.attach("addView",function(a,b){!0===(null!=b?b.showOnAdd:void 0)&&d.showChild(a,!0)});b=a.showIndex||0;this.children&&(0<=b&&b<this.children.length)&&(this._previousView=this._currentView=this.children[b]);this.render()},render:function(){this.showChild(this._currentView,!0);return this},addView:function(a,b){var d,h=this;a.$el.css({position:"absolute",width:"99%"});c.ContainerPlugin.addView.apply(this,arguments);if(d=this.navigationEvents)if(d=d[a.name])d=_.isArray(d)?d:[d],_.each(d,
function(b){h.attachNavigationEvent(a,b)});a.$el.hide()},addChild:function(a,b){0===this.children.length&&(b||(b={}),b.showOnAdd=!0);return c.ContainerPlugin.addChild.apply(this,[a,b])},removeChild:function(a){var b;a=this.getChild(a);a===this._currentView&&(b=_.indexOf(this.children,a),0<b?this.showChild(this.getChild(b-1),!0):this._previousView=this._currentView=null);return c.ContainerPlugin.removeChild.apply(this,arguments)},attachNavigationEvent:function(a,b){var d,c=this;!0===b.back?a.attach(a,
b.event,function(){c.onBack()}):b.target&&(d=_.find(this.children,function(a){return a.name===b.target}),a.attach(a,b.event,function(){c.showChild(d)}))},onBack:function(){this.showPreviousChild()},showChild:function(a,b){var d,c,e;a=this.getChild(a);d=_.indexOf(this.children,a)<_.indexOf(this.children,this._currentView);this._currentView&&(b||(c=this.effects[d?"HIDE_BACKWARD":"HIDE_FORWARD"]),this._currentView.$el.hide.apply(this._currentView.$el,c));b||(e=this.effects[d?"SHOW_BACKWARD":"SHOW_FORWARD"]);
a.$el.show.apply(a.$el,e);this._previousView=this._currentView;return this._currentView=a},showPreviousChild:function(){this._previousView&&this.showChild(this._previousView)}});c.ListView=c.View.extend({plugins:[c.TemplatePlugin,c.ContainerPlugin],messages:{NO_ITEMS:"No Items"},template:'<div class="main-node"><div class="container-node"></div><div class="message-node"></div></div><div class="loading-node">Loading...</div>',templateNodes:{containerNode:".container-node",messageNode:".message-node",
mainNode:".main-node",loadingNode:".loading-node"},itemView:c.View,initialize:function(a){var b,d=this;this.$el.addClass("list-view");a.itemView&&(this.itemView=a.itemView);c.View.prototype.initialize.apply(this,arguments);this.setLoading(!1);b=this.collection;b.on("reset",this.render,this);b._onAddModel=function(a,b,c){d.renderModel(a,c)};b.on("add",b._onAddModel);this.render()},render:function(){var a=this;this.toggleContainerNode(0<this.collection.models.length,this.messages.NO_ITEMS);this.clearChildren();
_.each(this.collection.models,function(b){a.renderModel(b,{silent:!0})});return this},toggleContainerNode:function(a,b){var d,c;c=this.messageNode;d=this.containerNode;a?(c.hide(),d.show()):(c.html(b),c.show(),d.hide())},renderModel:function(a,b){var d,c=this;d=this.createChild(a);a._onModelDestroy=function(){c.removeChild(d);a.off("destroy")};a.on("destroy",a._onModelDestroy);this.addChild(d,b);null!=b&&b.silent||this.toggleContainerNode(0<this.collection.models.length,this.messages.NO_ITEMS);return d},
createChild:function(a){return(new this.itemView(_.extend(this.itemOptions||{},{model:a}))).render()},removeChild:function(a,b){var d=this;a=this.getChild(a);!0===(null!=b?b.silent:void 0)?c.ContainerPlugin.removeChild.call(this,a):a.$el.hide("slide",{direction:"left"},"fast",function(){c.ContainerPlugin.removeChild.call(d,a);d.toggleContainerNode(0<d.collection.models.length,d.messages.NO_ITEMS)});return a},clearChildren:function(){_.each(this.collection.models,function(a){a._onModelDestroy&&a.off("destroy",
a._onModelDestroy)});c.ContainerPlugin.clearChildren.apply(this,arguments)},setLoading:function(a){a?(this.loadingNode.show(),this.mainNode.hide()):(this.loadingNode.hide(),this.mainNode.show())},destroy:function(){var a;this.clearChildren();a=this.collection;a.off("reset",this.render);a.off("add",a._onAddModel);c.View.prototype.destroy.apply(this,arguments)}});r=c.ActionView.extend({actions:{left:[{iconClass:"delete-icon",title:"Confirm delete",onClicked:"onRemoveConfirmButtonClicked"}],right:[{iconClass:"reorder-handle",
title:"Reorder"},{iconClass:"delete-button",title:"Delete",text:"Delete",onClicked:"onRemoveButtonClicked"}]},onRemoveConfirmButtonClicked:function(a){var b;b=this.$el.hasClass("remove-confirm");this.$el.toggleClass("remove-confirm",!b);a.stopPropagation()},onRemoveButtonClicked:function(a){this.child.model.destroy();a.stopPropagation()}});c.EditableListView=c.ListView.extend({plugins:[c.TemplatePlugin,c.ContainerPlugin,c.SortablePlugin],sortableOptions:{handle:".reorder-handle"},initialize:function(a){this.$el.addClass("editable-list-view");
c.ListView.prototype.initialize.apply(this,arguments);this.setEditable(!0===a.editable||!1)},setEditable:function(a){this.setSortable(a);this.containerNode.toggleClass("listview-edit",a)},createChild:function(a){return(new r({itemView:this.itemView,itemOptions:_.extend(this.itemOptions||{},{model:a})})).render()}});c.TabButtonView=c.View.extend({tagName:"a",attributes:{href:"#","class":"tab-button"},plugins:[c.TemplatePlugin],template:_.template("<%- title %>"),events:{click:"onClicked"},onClicked:function(a){}});
c.TabView=c.StackView.extend({plugins:[c.TemplatePlugin,c.ContainerPlugin],template:'<div class="tab-button-container"></div><div class="tab-content-container"></div>',templateNodes:{containerNode:".tab-content-container"},autoRender:!1,render:function(){this._buttonMap={};this.buttonContainer=new c.View({el:".tab-button-container",plugins:[c.ContainerPlugin]});this.renderContainer();c.StackView.prototype.render.apply(this,arguments);return this},addView:function(a,b){var d,h;c.StackView.prototype.addView.apply(this,
arguments);h=this;d=new c.TabButtonView({title:a.title||a.name,onClicked:function(a){h.showChild(this._tabContentView)}});this.buttonContainer.addChild(d);this._buttonMap[a.cid]=d;d._tabContentView=a},removeChild:function(a){var b,d;if(b=c.StackView.prototype.removeChild.apply(this,arguments))d=this._buttonMap[b.cid],this.buttonContainer.removeChild(d),d.destroy(),delete this._buttonMap[b.cid];return b},showChild:function(a){var b;if(a=c.StackView.prototype.showChild.apply(this,[a,!0]))b=this._buttonMap,
this._previousView&&b[this._previousView.cid].$el.removeClass("selected"),b[a.cid].$el.addClass("selected");return a}});c.GoogleMapView=c.View.extend({apiKey:"",defaultLocation:{lat:-34.397,lng:150.644},subscribers:{GOOGLE_MAP_SCRIPT_LOADED:"_onScriptLoaded"},initialize:function(a){c.View.prototype.initialize.apply(this,arguments);a.el||this.$el.css({width:"100%",height:"100%"})},initMap:function(){var a;if(!this.apiKey||0===this.apiKey.length)throw Error("You need Google Map API key to use this widget");
